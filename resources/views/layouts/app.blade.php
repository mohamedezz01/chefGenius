...
{{-- Use data attribute for JS auth check --}}
...
{{-- <-- ADD THIS LINE --}}
    ...
    <header class="bg-white border-b border-gray-200 text-gray-800 p-4 shadow-sm flex justify-between items-center sticky top-0 z-40">
        <div class="flex items-center gap-2">
             {{-- CORRECTED LINK: Link logo to 'home' for logged-in users, '/' (login) for guests --}}
             <a href="{{ auth()->check() ? route('home') : route('login') }}" class="flex items-center gap-2">
                 <svg class="w-8 h-8 text-emerald-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L24 5.25l-.813 2.846a4.5 4.5 0 0 0-3.09 3.09L18.25 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09L12 18.75l.813-2.846a4.5 4.5 0 0 0 3.09-3.09L18.25 12Z" />
                 </svg>
    ...
    {{-- Removed inline script setting window.isAuthenticated - using data attribute on body now --}}
